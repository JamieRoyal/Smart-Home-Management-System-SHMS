...
def call_display():
    # subprocess.call(["python3", "/home/pi/Hygrometer/hygrometergui.py"]) #call the subprocess
    subprocess.call(["python3", os.path.join(sys._MEIPASS,
                                             "hygrometergui.py")])  # call the subprocess when creating executable use this line
        ...
        if not lines:  # if the file is empty ->
            ...
            while True:
                ...
                # catch errors
                    ...
                    error_reporting(
                        "Awaiting Sensor...")  # print error messages to the display but continue executing the program
                    time.sleep(30)
                    continue
